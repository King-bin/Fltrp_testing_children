...
<title>看词选图 UI - 高保真互动版</title>
<style>
  @import url('https://fonts.googleapis.com/css2?family=Nunito:wght@700;800;900&display=swap');

  :root {
    --bg-color: #9AA96B;         /* 橄榄绿背景 */
    --card-outer: #FCE18D;       /* 卡片外圈淡黄色 */
    --card-inner: #FCFAF2;
    --card-dash: #F5D381;
    --text-brown: #5C402B;       /* 单词深棕色 */
    --badge-top: #FFC458;        /* 选项角标渐变 */
    --badge-bottom: #F9981D;
    --btn-back: #7DC632;         /* 返回按钮绿 */
    --btn-back-shadow: #5DA51B;
  ...
  * {
  ...
  .back-btn {
    ...
    box-shadow: 0 0.4vw 0 var(--btn-back-shadow), inset 0 0.6vw 0.5vw rgba(255,255,255,0.4);
    cursor: pointer;
    display: flex;
    justify-content: center;
    align-items: center;
  ...
  .back-btn:active { 
    ...
    box-shadow: 0 0.1vw 0 var(--btn-back-shadow), inset 0 0.6vw 0.5vw rgba(255,255,255,0.4); 
  }
  ...
  .word-text {
    ...
    text-shadow: 0 0.2vw 0 rgba(0,0,0,0.02);
  }
  ...
  .btn-sp-1 { width: 0.6vw; top: 20%; left: 10%; }
  .btn-sp-2 { width: 0.5vw; bottom: 25%; right: 12%; }
